...
namespace CafeShopManagementSystem
{
    ...
    {
        SqlConnection connect = new SqlConnection(@"Data Source=DESKTOP-M26C3G9;Initial Catalog=aplikasiCafe;Integrated Security=True");
                ...
                try
                {
                    ...
                    using(SqlCommand cmd = new SqlCommand(selectOrders, connect))
                    {
                        ...
                        while (reader.Read())
                        {
                            ...
                            coData.Price = Convert.ToDecimal(reader["prod_price"]);
