...
namespace CafeShopManagementSystem
{
    public partial class Form1 : Form
    {
        ...
        private void login_btn_Click(object sender, EventArgs e)
        {
            if (emptyFields())
            {
                MessageBox.Show("Semua kolom harus diisi.", "Error Message", MessageBoxButtons.OK);
            }
            else
            {
                        ...
                        using (SqlCommand cmd = new SqlCommand(selectAccount, connect))
                        {
                            ...
                            if(rowCount > 0)
                            {
                                ...
                                using(SqlCommand getRole = new SqlCommand(selectRole, connect))
                                {
                                    ...
                                    MessageBox.Show("Login sukses!", "Information Message", MessageBoxButtons.OK, MessageBoxIcon.Information);
                            ...
                            {
                                MessageBox.Show("Nama Pengguna/Kata Sandi salah atau tidak ada persetujuan Admin.", "Error Message", MessageBoxButtons.OK, MessageBoxIcon.Error);
